...
## Sample Web Page
![image](https://github.com/eatrabyo/dads_5001_dash_app_for_ml/assets/114765725/f39943d9-cbc0-4f51-bd7e-f6840a579c71)
...
## Component Part
  ...
  6. Confusion matrix
  7. Model Performance (Accuracy score)
...
### 5. Classification report
The classification report is a performance evaluation tool for model. t provides a comprehensive summary of the model's performance by presenting various metrics such as precision, recall, F1-score, and support for each class in the dataset.
  1. Precision  : Also known as positive predictive value, it measures the accuracy of the positive predictions made by the model. It is the ratio of true                          positives to the sum of true positives and false positives.
  2. Recall     : Also known as sensitivity or true positive rate, it measures the ability of the model to correctly identify positive instances. It is the ratio                 of true positives to the sum of true positives and false negatives.
  3. F1-score   : It is the harmonic mean of precision and recall, providing a balanced measure that considers both metrics. It ranges between 0 and 1, where 1                   indicates the best possible value.

![image](https://github.com/eatrabyo/dads_5001_dash_app_for_ml/assets/114765725/32f390c3-3e63-44cf-abcc-fc3ef247e095)
